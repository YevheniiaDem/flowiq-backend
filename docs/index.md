...
- [ADR-003: AI Quality Factory](architecture/adr/003-ai-quality-factory.md)
- [ADR-004: PostgreSQL Selection](architecture/adr/004-postgresql-selection.md)
- [ADR-005: Flyway Selection](architecture/adr/005-flyway-selection.md)
- [ADR-006: JWT Authentication Strategy](architecture/adr/006-jwt-authentication-strategy.md)
- [ADR-007: Layered Architecture](architecture/adr/007-layered-architecture.md)
- [ADR-008: Frontend Architecture](architecture/adr/008-frontend-architecture.md)

## API Reference

- [OpenAPI Overview](api/openapi-overview.md)
...
- [Knowledge / Business Guide API](api/knowledge-api.md)
...
- [Tasks & Deadlines Center](modules/tasks-center.md)
- [Business Guide / Knowledge Base](modules/business-guide.md)
- [Notifications](modules/notifications.md)
- [Authentication](modules/authentication.md)
- [Transactions](modules/transactions.md)
...
- [Terms of Service Draft](legal/terms-of-service-draft.md)
